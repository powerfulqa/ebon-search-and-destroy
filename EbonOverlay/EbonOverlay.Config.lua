...
local L = EbonOverlayLocalization;
local me = CreateFrame( "Frame" );
Overlay.Config = me;

me.ShowAll = CreateFrame( "CheckButton", "EbonOverlayConfigShowAllCheckbox", me, "InterfaceOptionsCheckButtonTemplate" );

local ModuleMethods = setmetatable( {}, getmetatable( me ) );
me.ModuleMeta = { __index = ModuleMethods; };

local IsChildAddOn = IsAddOnLoaded( "EbonSearch" );




--[[****************************************************************************
  * Function: EbonOverlay.Config.ModuleMeta.__index:AddControl            *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config.ModuleMeta.__index:SetEnabled            *
  ****************************************************************************]]
do
...
--[[****************************************************************************
  * Function: EbonOverlay.Config.ModuleMeta.__index:Unregister            *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:ControlOnEnter                           *
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:ModuleCheckboxSetEnabled                 *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:ModuleSliderSetEnabled                   *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config.ShowAll.setFunc                          *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:ModuleEnabledOnClick                     *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:ModuleAlphaOnValueChanged                *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config.ModuleRegister                           *
  ****************************************************************************]]
do
	local LastFrame;
	function me.ModuleRegister ( Module, Label )
		local Frame = CreateFrame( "Frame", "EbonOverlayModule"..Module.Name, me.ScrollChild, "OptionsBoxTemplate" );
		Frame.Module = Module;
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:default                                  *
  ****************************************************************************]]
function me:default ()
	Overlay.Synchronize();
end
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:TableSetHeader                           *
  ****************************************************************************]]
	local Args = {};
	local select = select;
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:TableSetSortHandlers                     *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:TableAddRow                              *
  ****************************************************************************]]
	local AddRowBackup;
...
--[[****************************************************************************
  * Function: EbonOverlay.Config:TableCreate                              *
  * Description: Hooks EbonSearch's "Search" table to add a zone column.         *
  ****************************************************************************]]
...
--[[****************************************************************************
  * Function: EbonOverlay.Config.SlashCommand                             *
...
local ScrollFrame = CreateFrame( "ScrollFrame", "EbonOverlayScrollFrame", Background, "UIPanelScrollFrameTemplate" );
...
if ( IsChildAddOn ) then
	Overlay.SafeCall( function ()
		me.parent = assert( EbonSearch.Config.name );
		TableCreateBackup = assert( EbonSearch.Config.Search.TableCreate );
		EbonSearch.Config.Search.TableCreate = me.TableCreate;
	end );
end
InterfaceOptions_AddCategory( me );

SlashCmdList[ "_EBONSEARCH_OVERLAY" ] = me.SlashCommand;