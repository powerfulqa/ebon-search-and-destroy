...
EbonSearch.L = setmetatable( {
	...
	CONFIG_DESC = "Ces options vous permettent de définir comment EbonSearch vous prévient quand il trouve un PNJ rare.",
...
_G[ "BINDING_NAME_CLICK EbonSearchButton:LeftButton" ] = [=[Cibler dernier monstre trouvé
|cff808080(Utile qd EbonSearch vous alerte)|r]=];